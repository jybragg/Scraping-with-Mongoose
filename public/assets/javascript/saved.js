...
$(document).ready(function () {
    ...
    function renderEmpty() {
        ...
        var emptyAlert =
            $(["<div class = 'alert alert-warning text-center'>",
                ...
                "<h3>Would you like to browes available articles?</h3>",
                "</div>",
                "<div class = 'panel-body text-center'>",
                "<h4><a class = 'scrape-new'>Scrape New Articles</a></h4>",
                "<h4><a href='/'>Borwse Articles</a></h4>",
                "</div>",
                "</div>"
            ].join(""));
    ...
    function handleArticleDelete() {
        ...
        var articleToDelete = $(this).parents(".panel").date();
    ...
    function handleNoteSave() {
        var noteData;
        var newNote = $(".bootbox-body testarea").val().trim();
